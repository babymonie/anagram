...
public:
	...
	void setTranslateUrlTemplate(const QString &value);
	[[nodiscard]] QString translateUrlTemplate() const;
	void setWhisperApiUrl(const QString &value);
	[[nodiscard]] QString whisperApiUrl() const;
	void setWhisperApiKey(const QString &value);
	[[nodiscard]] QString whisperApiKey() const;
	void setAiComposeApiUrl(const QString &value);
	[[nodiscard]] QString aiComposeApiUrl() const;
	void setAiComposeApiKey(const QString &value);
	[[nodiscard]] QString aiComposeApiKey() const;
	void setAiComposeApiModel(const QString &value);
	[[nodiscard]] QString aiComposeApiModel() const;
	void setBettergramHubUrl(const QString &value);
	[[nodiscard]] QString bettergramHubUrl() const;
	void setBgAvatarUrl(const QString &value);
	[[nodiscard]] QString bgAvatarUrl() const;
	void setBgNameColor(const QString &value);
	[[nodiscard]] QString bgNameColor() const;
	void setBgHubAdminToken(const QString &value);
	[[nodiscard]] QString bgHubAdminToken() const;

	// BetterGram power features
	void setBgGhostMessages(bool value);
	[[nodiscard]] bool bgGhostMessages() const;
	void setBgAlwaysShowTimestamps(bool value);
	[[nodiscard]] bool bgAlwaysShowTimestamps() const;
	void setBgCharCounter(bool value);
	[[nodiscard]] bool bgCharCounter() const;
	void setBgLinkDeTracker(bool value);
	[[nodiscard]] bool bgLinkDeTracker() const;
	void addBgTypingSuppressedPeer(uint64 peerId);
	void removeBgTypingSuppressedPeer(uint64 peerId);
	[[nodiscard]] bool isBgTypingSuppressed(uint64 peerId) const;
	[[nodiscard]] QVector<uint64> bgTypingSuppressedPeers() const;
	void setBgPeerNote(uint64 peerId, const QString &note);
	[[nodiscard]] QString bgPeerNote(uint64 peerId) const;
	void setBgPeerSound(uint64 peerId, const QString &path);
	[[nodiscard]] QString bgPeerSound(uint64 peerId) const;

	// BetterGram theme engine
	void setBgThemeName(const QString &name);
	[[nodiscard]] QString bgThemeName() const;
	void setBgHubThemeSync(bool value);
	[[nodiscard]] bool bgHubThemeSync() const;

	// BetterGram mini-player
	void setBgMiniPlayerEnabled(bool value);
	[[nodiscard]] bool bgMiniPlayerEnabled() const;

	// Stories visibility
	void setHideStoriesBar(bool value);
	[[nodiscard]] bool hideStoriesBar() const;
	void setHideStoryBadges(bool value);
	[[nodiscard]] bool hideStoryBadges() const;
	void setHideStoryNotifications(bool value);
	[[nodiscard]] bool hideStoryNotifications() const;

	// Premium hiding
	void setHidePremiumBadges(bool value);
	[[nodiscard]] bool hidePremiumBadges() const;
	void setHidePremiumUpsells(bool value);
	[[nodiscard]] bool hidePremiumUpsells() const;
	void setHidePremiumMenuItems(bool value);
	[[nodiscard]] bool hidePremiumMenuItems() const;
	void setHideUpgradeButtons(bool value);
	[[nodiscard]] bool hideUpgradeButtons() const;
	void setHideSponsoredMessages(bool value);
	[[nodiscard]] bool hideSponsoredMessages() const;

	// Fires whenever any BetterGram-specific setting above changes, so
	// Settings UI rows can rebind to live values instead of one-shot reads.
	[[nodiscard]] rpl::producer<> bettergramChanges() const {
		return _bettergramChanged.events();
	}
...
private:
	...
	rpl::event_stream<> _bettergramChanged;
